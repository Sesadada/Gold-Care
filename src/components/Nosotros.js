    ...
    <div name="nosotros" className="w-full my-20">
      <div className="max-w-[1240px] mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-1 px-2 mt-4">
          <div className="border-4 py-8 rounded-xl border-skin-bazul shadow-xl p-4 m-4 mt-[-10rem] bg-white">
          ...
          <div className="border-4 py-8 rounded-xl border-skin-bazul-oscuro shadow-xl p-4 m-4 md:mt-[-10rem] bg-white">
